...
app.get('/api/manhwa-recomendation', async (req, res) => {
  try {
    // URL yang akan di-scrape
    const url = 'https://komikcast.cz/daftar-komik/?status=Ongoing&type=&orderby=popular';
...
// DATA GENRE
  app.get('/api/data', async (req, res) => {
    try {
        const url = 'https://komikcast.cz/daftar-komik/?list'; // Replace with the actual URL
        const { data } = await axios.get(url);
        const $ = load(data);
...
app.get('/api/genre/:genreId', async (req, res) => {
  ...
  const url = `https://komikcast.cz/genres/${genreId}`;
...
app.get('/api/genre/:genreId/page/:pageNumber', async (req, res) => {
  ...
  const url = `https://komikcast.cz/genres/${genreId}/page/${pageNumber}`;
...
app.get('/api/page/:pageNumber/search/:searchId', async (req, res) => {
  ...
  const url = `https://komikcast.cz/page/${pageNumber}/?s=${searchId}`;
...
app.get('/api/manhwa-detail/:manhwaId', async (req, res) => {
  ...
  const url = `https://komikcast.cz/komik/${manhwaId}`;
...
app.get('/api/manhwa-ongoing', async (req, res) => {
  try {
      const url = 'https://komikcast.cz/daftar-komik/?status=Ongoing&type=manhwa&orderby=titleasc';
...
app.get('/api/chapter/:chapterId', async (req, res) => {
  ...
  const url = `https://komikcast.cz/${chapterId}`; // Sesuaikan URL jika perlu
